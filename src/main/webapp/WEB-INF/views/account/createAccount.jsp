					...
					<body class="hold-transition register-page">
						<div class="register-box">
							<div class="register-logo">
								<a href="../../index2.html"><b>Poll</b>InLuv</a>
							</div>
							...
							<div class="register-box-body">
								...
								<form action="/account/createAccount" method="post">
									...
									<div class="form-group has-feedback">
										...
										id="userPw" placeholder="Password"> <span
											class="glyphicon glyphicon-lock form-control-feedback"></span>
									</div>
									<div class="form-group has-feedback">
										<input type="password" class="form-control" name="userPwCheck"
										id="userPwCheck" placeholder="Retype password"> <span
								...
								<div class="social-auth-links text-center">
									...
									<a href="#"
										...
										class="fa fa-facebook"></i> Sign up using Facebook</a> <a
